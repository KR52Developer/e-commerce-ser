...
// update cart items in cart quantity
...
//             { "items._id": itemId }, { $set: { "items.$.quantity": quantity } }, { new: true }
...
//     console(quantity);
//     console.log(itemId);
//     Cart.findByIdAndUpdate(itemId, {
//         quantiy: quantity
//     }, { new: true })
//         .then((updatedProduct) => res.status(200).json({ success: true, message: "Successfully updated the product", updatedProduct: updatedProduct }));
// };
